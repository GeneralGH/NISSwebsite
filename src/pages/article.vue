  ...
  <div>
    ...
    <div class="page-area">
      <div class="path-list" @click="backPage">
        <span class="upPath">{{
            data.type == 1 ? userLanguage == '1' ? '关于我们' : 'About Us' : userLanguage == '1' ? '校友风采' : 'Alumni'
          }} / </span>
        <span>{{
            data.type == 1 ? userLanguage == '1' ? '学院新闻' : 'College News' : userLanguage == '1' ? '校友动态' : 'Alumni Updates'
          }}</span>
      </div>
      ...
      <div class="article-info">
        ...
        <div class="article-author">
          作者：{{ userLanguage == '1' ? data.author : data.authorEn }}&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;{{
