...
export default {
  ...
  data() {
    ...
    return {
      ...
      isSmallScreen: false,
      isNoTopImgPages: ['/article', '/highEdu', '/policy', '/contactUs', '/mbaProfessors', '/Professors', '/AmbassadorDetail', '/student-code-of-conduct', '/contract', '/fee-protection-scheme', '/privacypolicy', '/grievancepolicy'],
      openWindow: false
    };
  },
  computed: {
